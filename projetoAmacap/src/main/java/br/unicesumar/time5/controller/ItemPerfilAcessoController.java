...
@Controller
@RequestMapping("/itemP erfilAcesso")
@Scope(WebApplicationContext.SCOPE_SESSION)

public class ItemPerfilAcessoController implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = LoggerFactory.getLogger(ItemPerfilAcessoController.class);
