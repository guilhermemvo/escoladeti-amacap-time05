...
public class CidadeService extends AbstractService<Cidade> {
    ...
    public Cidade getCodeLocalization(Cidade cidade) {

        return getCidadeRepository().findByCodigoIBGE(cidade.getCodigoIBGE());
    }
    ...
    public Page<Cidade> executeQueryEncontrarPorNome(int pagina, int totalPorPagina, String nome) {
        ...
        return cidadeRepository.findByNomeLike(pageRequest, "%" + nome + "%");
    }
