...
public class PaisService extends AbstractService<Pais> {
    ...
    public Pais getCodeLocalization(Pais pais) {
        return getPaisRepository().findByCodigoIBGE(pais.getCodigoIBGE());
    }
    ...
    public Page<Pais> executeQueryEncontrarPorNome(int pagina, int totalPorPagina, String nome) {
        ...
        return paisRepository.findByNomeLike(pageRequest, "%" + nome + "%");
    }
