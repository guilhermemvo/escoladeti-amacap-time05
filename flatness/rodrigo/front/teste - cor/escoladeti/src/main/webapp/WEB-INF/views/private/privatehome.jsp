...
<html xmlns:ng="http://angularjs.org" lang="pt">
    <head>
        ...
        <script type="text/javascript" src="./resources/app/cor/cor.js"></script>
                    ...
                    <ul class="nav navbar-nav">              
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="#/cadastros/cor/listar">Cor</a></li>
                                <li><a href="#/cadastros/endereco/listar">Endereco</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
